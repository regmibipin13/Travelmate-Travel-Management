    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.packages.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('package_type') ? 'is-invalid' : '' }}" name="package_type_id" id="package_type_id" required>
                    @foreach($package_types as $id => $entry)
                        <option value="{{ $id }}" {{ old('package_type_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_people') ? 'is-invalid' : '' }}" type="number" name="max_people" id="max_people" value="{{ old('max_people', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('package_title') ? 'is-invalid' : '' }}" type="text" name="package_title" id="package_title" value="{{ old('package_title', '') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('trip_highlights') ? 'is-invalid' : '' }}" name="trip_highlights" id="trip_highlights">{!! old('trip_highlights') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('trip_difficulties') ? 'is-invalid' : '' }}" name="trip_difficulties" id="trip_difficulties">{!! old('trip_difficulties') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('best_season') ? 'is-invalid' : '' }}" name="best_season" id="best_season">{!! old('best_season') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('accommodation') ? 'is-invalid' : '' }}" name="accommodation" id="accommodation">{!! old('accommodation') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('included') ? 'is-invalid' : '' }}" name="included" id="included">{!! old('included') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('excluded') ? 'is-invalid' : '' }}" name="excluded" id="excluded">{!! old('excluded') !!}</textarea>
